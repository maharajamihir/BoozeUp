...
function setSplashInfoPlist(config, infoPlist, splash) {
  ...
  if (isDarkModeEnabled) {
    ...
    if (existing && existing !== 'automatic') {
      _configPlugins().WarningAggregator.addWarningIOS('splash', 'The existing `userInterfaceStyle` property is preventing splash screen from working properly. Please remove it or disable dark mode splash screens.');
